...
### What I'm focused on
- **Pharmacovigilance & RWE** — signal detection, disproportionality analysis, real-world data
- **Clinical machine learning** — risk prediction, interpretable models for health systems
- **Turning analysis into decisions** — communicating findings to non-technical stakeholders

### Featured project
🔬 **[FAERS Drug-Safety Signal Analysis](https://github.com/PeckDJ/FAERS-Drug-Safety-Signal-Analysis)**
Detecting adverse-drug-reaction safety signals from 1.5M+ FDA FAERS reports using
...
- 💼 https://www.linkedin.com/in/peckming1226/
